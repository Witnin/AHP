...
public class BottomNavigationBar extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        tv_first.setTextColor(greyColor);
        tv_second.setTextColor(greyColor);
        tv_third.setTextColor(greyColor);
        tv_fourth.setTextColor(greyColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int high = 90;//底部导航的高度 80
        int marginTop = 30;//剧顶边高度 30
        Log.d("onDraw", "width:" + width);
        Log.d("onDraw", "width:" + dip2px(120));
        Log.d("onDraw", "width:" + dip2px(130));
        Log.d("onDraw", "width:" + dip2px(140));
        int x1 = (int)(width/2.7); //120 参考1080/3
        int x2 = (int)(width/2.5); //130  参考1080/2.8
        int x3 = (int)(width/2.3); //140  参考1080/2.6
