...
import com.wsy.ahp.activity.map.adapter.SearchResultAdapter;
import com.wsy.ahp.activity.map.view.SegmentedGroup;
import com.wsy.ahp.http.common.ArouterUrl;

import java.util.ArrayList;
import java.util.List;

@Route(path = ArouterUrl.MAP_WEATHER)
public class MapChooseActivity extends AppCompatActivity implements LocationSource,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(MapChooseActivity.this, "搜索失败 " , Toast.LENGTH_SHORT).show();
        }
...
//        Log.i("MY", "doSearchQuery");
    ...
    private void searchPoi(Tip result) throws AMapException {
        ...
        if(searchLatlonPoint!=null){
            ...
            Toast.makeText(MapChooseActivity.this, "查询失败，请选择具体位置", Toast.LENGTH_SHORT).show();
        }
