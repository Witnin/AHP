...
import com.wsy.ahp.kotlin.cvOf
import com.wsy.ahp.kotlin.cvOf2
...
//            val values = cvOf2("name" to "Within", "author" to "George Martin",
//                "pages" to 720, "price" to 20.85)
//            db.insert("Book", null, values)

            val values = contentValuesOf("name" to "Within", "author" to "George Martin",
                "pages" to 720, "price" to 20.85)
            db.insert("Book", null, values)
        }
